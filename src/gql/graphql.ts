...
export type SomeEgRocketsQueryVariables = Exact<{ [key: string]: never; }>;


export type SomeEgRocketsQuery = { __typename?: 'Query', rockets?: Array<{ __typename?: 'Rocket', description?: string | null } | null> | null };


export const SomeEgRocketsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SomeEGRockets"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rockets"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<SomeEgRocketsQuery, SomeEgRocketsQueryVariables>;